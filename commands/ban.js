...
if(!message.member.hasPermission(["BAN_MEMBERS"])) return message.channel.send("<a:redcross:688007167755944007> You must have BAN_MEMBERS permission to perform this command!")

    let BanMember = message.mentions.users.first() || message.guild.members.cache.get(args[0])
